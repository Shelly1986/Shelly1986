...
const words = new Map([
  ...
  ['memory', 'Computer uses it to store information'],
  ['spacebar', 'A key on the keyboard'],
  ['printer', 'A device which converts text on computer to a paper'],
  ['mouse','A pointer on screen'],
  ['CPU', 'Brain of the computer'],
  ['hardware','Parts of a computer that you can touch and feel']
]);
